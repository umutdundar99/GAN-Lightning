...
class Mobilenetv2_Feature_Extractor(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.bottleneck1 = self._make_layer(MobileNetV2Bottleneck, in_channels, block_channels[0], 3, t, 2)
        self.bottleneck2 = self._make_layer(MobileNetV2Bottleneck, block_channels[0], block_channels[1], 3, t, 2)
        self.bottleneck3 = self._make_layer(MobileNetV2Bottleneck, block_channels[1], block_channels[2], 3, t, 1)
